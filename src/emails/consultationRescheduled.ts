...
interface ConsultationRescheduledData {
  customerName: string
  orderNumber: string
  serviceName: string
  startTime: Date
...
export function consultationRescheduledHtml(data: ConsultationRescheduledData): string {
  ...
  <tr>
    <td style="padding:40px 48px;">
      <h2 style="margin:0 0 8px;color:#1f1f2e;font-size:22px;font-weight:700;">Your Consultation Has Been Rescheduled</h2>
      <p style="margin:0 0 24px;color:#6b7280;font-size:14px;">Order #${orderNumber}</p>

      <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6;">
        Hi ${customerName}, your <strong>${serviceName}</strong> consultation has been moved to a
        new time. Here are your updated session details:
      </p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="padding:6px 0;">
              <span style="color:#6b7280;font-size:13px;display:block;">New date</span>
              <span style="color:#1f1f2e;font-size:15px;font-weight:600;">${dateStr}</span>
            </td>
          </tr>
          <tr>
            <td style="padding:6px 0;">
              <span style="color:#6b7280;font-size:13px;display:block;">New time (IST)</span>
      ...
      <p style="margin:0 0 8px;color:#9ca3af;font-size:13px;">
        Your Google Meet link stays the same — please update your calendar to the new date and time above.
      </p>
